...
export const artworks: Artwork[] = [
  ...
  // ===== Traditional (pencil) =====
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-ganesha/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-ink-mashup/final.jpg') }],
  },
  {
    slug: 'sketch-thor',
    title: 'Thor',
    ...
    stages: [{ label: 'Final', src: asset('sketch-thor/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-wolverine/final.jpg') }],
  },
  {
    slug: 'sketch-joker',
    title: 'Joker',
    ...
    stages: [{ label: 'Final', src: asset('sketch-joker/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-harley-quinn/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-justice-league/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-figure-studies/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-wonder-woman/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-spider-man-3/final.jpg') }],
  },
  {
    slug: 'sketch-hanuman',
    title: 'Hanuman',
    ...
    stages: [{ label: 'Final', src: asset('sketch-hanuman/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-veera-hanuman/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-gabbar-singh/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-ganesha-standing/final.jpg') }],
  },
  {
    slug: 'sketch-mahadev',
    title: 'Mahadev',
    ...
    stages: [{ label: 'Final', src: asset('sketch-mahadev/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-the-king/final.jpg') }],
  },
  {
    ...
    stages: [{ label: 'Final', src: asset('sketch-panchamukha-ganapati/final.jpg') }],
  },
  {
  ...
  },
  {
    ...
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-batman/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-batman/final.jpg') }],
  },
  {
    slug: 'sketch-aquaman',
    title: 'Aquaman',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-aquaman/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-aquaman/final.jpg') }],
  },
  {
    slug: 'sketch-ganesha-seated',
    title: 'Ganesha',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-ganesha-seated/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-ganesha-seated/final.jpg') }],
  },
  {
    slug: 'sketch-mahadev-standing',
    title: 'Mahadev',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-mahadev-standing/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-mahadev-standing/final.jpg') }],
  },
  {
    slug: 'sketch-scar-pumbaa',
    title: 'Lion King',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-scar-pumbaa/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-scar-pumbaa/final.jpg') }],
  },
  {
    slug: 'sketch-warrior',
    title: 'Wonder Woman',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-warrior/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-warrior/final.jpg') }],
  },
  {
    slug: 'sketch-inktober',
    title: 'Inktober',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-inktober/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-inktober/final.jpg') }],
  },
  {
    slug: 'sketch-mahesh-babu',
    title: 'Mahesh Babu',
    medium: 'Pencil',
    style: 'traditional',
    cover: asset('sketch-mahesh-babu/final.jpg'),
    stages: [{ label: 'Final', src: asset('sketch-mahesh-babu/final.jpg') }],
  },
]
